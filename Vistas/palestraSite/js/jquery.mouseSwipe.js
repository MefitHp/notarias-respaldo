...
$("#team").on("click", ".swipe-link", function (e) {
    e.preventDefault();
...
var update=function(len) {
  ...
  $(elm).closest("section").find(".swipe-link").removeClass("swipe-active");
  $(elm).closest("section").find(".swipe-link").eq(panelnum - 1).addClass("swipe-active");
