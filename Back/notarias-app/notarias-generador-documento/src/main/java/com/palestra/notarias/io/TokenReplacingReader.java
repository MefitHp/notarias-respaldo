 ...
 * String.replace() method. Got the code from
 * http://tutorials.jenkov.com/java-howto
 * /replace-strings-in-streams-arrays-files.html
 * 
 * Solo se puede utilizar para los marcadores '${...}'. Los cuales no son 
 * modificables, en caso de que querer utilizar cualquier marcador otro
 * utilizar la clase {@link TokenMarkerReplacingReader}
 * 
