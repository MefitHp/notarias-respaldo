...
public class DgieWSLocator extends org.apache.axis.client.Service implements ws.client.DgieWS {
    ...
    public ws.client.DgieWSPort_PortType getDgieWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.client.DgieWSPortSoapBindingStub _stub = new ws.client.DgieWSPortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.client.DgieWSPort_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.client.DgieWSPortSoapBindingStub _stub = new ws.client.DgieWSPortSoapBindingStub(new java.net.URL(DgieWSPort_address), this);
                _stub.setPortName(getDgieWSPortWSDDServiceName());
                return _stub;
            }
        }
